...
<ul >
<li id="insidel"> <a href="santhwanakendram.php"> <img src="images/v1/Santhwana.png" alt="santhwana"/> </a> </li>
<li id="insidel"> <a href="rotary-mammobus.php"> <img src="images/v1/mammobus.png" alt="santhwana"/> </a> </li>
</ul>
</li>
