...
public class PatientHospitalVisitWorkflowServiceImpl implements PatientHospitalVisitWorkflowService {
    ...
    private void selectPartners(List<PatientVisitForwardsBean> forwardList, Integer pidn, Integer patientVisitId)
            throws Exception {
    ...
    public PatientVisitHistoryBean selectPatient(String pidnString) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            document = patientDocumentService.findByPrn(patientBean.getPrn());
            ...
            patientBean.setDocument(documentBean);
            ...
            for (PatientVisit patientVisit : openList) {
                ...
                List<PatientBills> patientBills = patientBillService
                        .getPatientBillByPatientVisitId(patientVisit.getId());
            ...
            if (patientApprovals != null && !patientApprovals.isEmpty()) {
                ...
                if (invoicesList != null && !invoicesList.isEmpty()) {
                    ...
                    for (InvoicesEntity entity : invoicesList) {
                        ...
                        bean.setFromAccountHolderName(
                                getPartnerName(entity.getFromAccountTypeId().getId(), entity.getFromAccountHolderId()));
    ...
    public String startInPatientWorkflow(PatientVisitBean patientVisitBean, Integer myUserId) throws Exception {
        ...
        entity.setBalanceAmount(patientVisitBean.getAmount());
