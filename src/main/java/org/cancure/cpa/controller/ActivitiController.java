...
public class ActivitiController {
    ...
    public @ResponseBody Map<String, String> listTasks(@PathVariable String roleId) {
    ...
    public String startPatientRegn(@PathVariable String patientId) {
        ...
        return patientRegistrationService.startPatientRegnProcess(variables, patientId);
    }
    ...
    public String backgroundCheck(@PathVariable String patientId, @PathVariable String status) {
    ...
    public @ResponseBody String mbApprove(@PathVariable String patientId, @PathVariable String doctorId) {

        return patientRegistrationService.mbApprove(patientId, doctorId);
    }

    @RequestMapping("/secApproval/{patientId}/{status}")
    public String secApproval(@PathVariable String patientId, @PathVariable String status) {
    ...
    public @ResponseBody String ecApprovalInd(@PathVariable String patientId, @PathVariable String ecId) {

        return patientRegistrationService.ecApprove(patientId, ecId);
    }

    @RequestMapping("/ecRejectInd/{patientId}/{ecId}")
    public @ResponseBody String ecRejectInd(@PathVariable String patientId, @PathVariable String ecId) {
