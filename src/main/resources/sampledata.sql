...
insert into user values (3,'Dr. One','drone','one@cancure.in.net','$2a$10$G5Hv6YeTOfV7SKU2s9rHEO3ZRGB6KjeeQIZi44xCL.flTQZeHFTm2', true, false);
insert into user values (4,'Dr. Two','drtwo','two@cancure.in.net','$2a$10$G5Hv6YeTOfV7SKU2s9rHEO3ZRGB6KjeeQIZi44xCL.flTQZeHFTm2', true, false);
insert into user values (5,'Dr. Three','drthree','three@cancure.in.net','$2a$10$G5Hv6YeTOfV7SKU2s9rHEO3ZRGB6KjeeQIZi44xCL.flTQZeHFTm2', true, false);
